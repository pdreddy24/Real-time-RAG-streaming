...
Ingestion → Messaging → Stream Processing → Medallion Modeling → RAG Index → Retrieval API → UI → Observability.
...
Why a Custom UI? The custom UI facilitates the demonstration of the “Real-Time” aspect of our project. We will be able to display the actual feed of changes together with the query box. This will give our stakeholders a sense of the freshness of our content.
